								...
								<div class="row">
									...
									<div class="col-12 col-sm-12 col-md-12 col-lg-12">
										<div class="form-group">
											...
											<input class="form-control" type="password" name="passwdchk"
												   placeholder="같은 비밀번호를 입력하세요" id="PasswordCheck" required>
									...
									<div class="col-12 col-sm-12 col-md-12 col-lg-12">
										<div class="form-group">
											...
											<input class="form-control" type="tel" name="phone"
												   placeholder="전화번호를 입력하세요" id="Phone" required>
										</div>
									</div>
									<div class="col-12 col-sm-12 col-md-12 col-lg-12">
										<div class="form-group">
									...
									<div class="col-12 col-sm-12 col-md-12 col-lg-12">
										<div class="form-group">
											...
											<input class="form-control" type="date" name="birth" placeholder="" id="Birth" required>
										</div>
									</div>
								</div>
								<br> <br>
