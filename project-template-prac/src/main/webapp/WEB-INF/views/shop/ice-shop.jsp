                ...
                <div class="col-12 col-sm-12 col-md-9 col-lg-9 main-col">
                	...
                	<div class="productList">
                        <div class="grid-products grid--view-items">
                            <div class="row">
	                            <c:forEach var="iceProduct" items="${ iceProducts }">
	                                <div class="col-6 col-sm-6 col-md-4 col-lg-4 item">
	                                    <!-- start product image -->
	                                    <div class="product-image">
	                                        <!-- start product image -->
	                                            <!-- image -->
	                                            <img class="primary blur-up lazyload" src="${ iceProduct.prodImg }" alt="image" title="product">
	                                            <!-- End image -->
	                                            <!-- Hover image -->
	                                            <img class="hover blur-up lazyload" src="${ iceProduct.prodImg }" alt="image" title="product">
	                                        <!-- end product image -->
	                                        ...
	                                        <c:choose>
	                                        	<c:when test="${ empty loginuser }">
	                                        		<form class="variants add addform" id="addform" action="login" method="post">
			                                        	<input type="hidden" name="prodId" value="${ iceProduct.prodId }">			                                        	
