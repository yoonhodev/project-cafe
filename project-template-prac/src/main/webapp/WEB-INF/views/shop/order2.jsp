				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
						<div class="alert alert-success text-uppercase" role="alert">
							<i class="icon anm anm-truck-l icon-large"></i>&nbsp; <strong>맛있게
								가져다드릴게요</strong>&nbsp; 항상 감사합니다 :)
						</div>
						...
						<div class="row">
							<div class="col-12 col-sm-12 col-md-4 col-lg-4 mb-4">
								...
								<form action="applycoupon" method="get" id="apply-coupon">
									<select id="couponName" name="couponId"
										class="form-group couponName">
								...
								<br><br>
								<h5>지점</h5>
								<form action="selectstore" method="get" id="order-select-store">
									<select id="selectStore" name="selectStore" class="form-group selectStore">
										...
										<c:forEach var="stores" items="${ store }"
											varStatus="status">
											<option id="store-option" value="${ store.storeName }">${ store.storeName }</option>
										</c:forEach>
									</select>
								</form>
							</div>
							...
							<div class="col-12 col-sm-12 col-md-4 col-lg-4 cart__footer">
								<div class="solid-border">
									<div class="row border-bottom pb-2">
										<span class="col-12 col-sm-6 cart__subtotal-title">음료
											금액</span> <span class="col-12 col-sm-6 text-right"> <span
											class="money"> <span id="drink-total"></span>
										</span>
										</span>
									</div>
									<div class="row border-bottom pb-2 pt-2">
										<span class="col-12 col-sm-6 cart__subtotal-title">쿠폰
											할인</span> <span class="col-12 col-sm-6 text-right" id="total-coupon">0
											원</span>
									...
									<div class="row border-bottom pb-2 pt-2">
										...
										<span class="col-12 col-sm-6 text-right" id="shipping">+
											3000 원</span>
									</div>
									<div class="row border-bottom pb-2 pt-2">
									...
									<br>
									<p class="cart_tearm">
										<strong>배달</strong>&nbsp;&nbsp;<input type="radio"
											name="orderType" value="A" checked>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>포장</strong>&nbsp;&nbsp;<input
											type="radio" name="orderType" value="B">
									</p>
									<input type="submit" name="checkout" id="cartCheckout"
										class="btn btn--small-wide checkout" value="결제"
										disabled="disabled">
