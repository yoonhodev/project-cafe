...
<body class="page-template belle cart-variant1">
			...
			<div class="container">
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
						...
						<form action="order" method="post" class="cart style2 delform">
							<table>
								...
								<tfoot>
									<tr>
										...
										<td colspan="3" class="text-right">
											<a href="delete-all-order" class="btn btn-secondary btn--small cart-continue ml-2 delete-all-order delform">장바구니 전체 삭제
												</a>
										</td>
									</tr>
								</tfoot>
	...
	<script type="text/javascript">
		...
		$('.delete-all-order').on('click', function(event) {
			var delform = $(this).parent(".delform").serialize();
