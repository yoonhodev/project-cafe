...
<nav
	...
	<div
		...
		<a class="navbar-brand brand-logo" href="admin"><img
			src="resources/admin-assets/images/logo.svg" alt="logo" /></a> <a
			...
			<li class="nav-item nav-profile dropdown"><a
				...
				data-toggle="dropdown" aria-expanded="false">
					<div class="nav-profile-img">
						<img src="resources/admin-assets/images/faces/face28.png"
							alt="image">
					</div>
				...
				<div
					...
					<div class="p-3 text-center bg-primary">
						<img class="img-avatar img-avatar48 img-avatar-thumb"
							src="resources/admin-assets/images/faces/face28.png" alt="">
					</div>
					<div class="p-2">
						...
						<a
							...
							class="dropdown-item py-1 d-flex align-items-center justify-content-between"
							href="#"> <span>Log Out</span> <i class="mdi mdi-logout ml-1"></i>
						</a>
					</div>
				</div></li>
				...
				<div
					...
					<a class="dropdown-item preview-item">
						<div class="preview-thumbnail">
							<img src="resources/admin-assets/images/faces/face4.jpg"
					...
					<a class="dropdown-item preview-item">
						<div class="preview-thumbnail">
							<img src="resources/admin-assets/images/faces/face2.jpg"
								alt="image" class="profile-pic">
						</div>
						<div
							class="preview-item-content d-flex align-items-start flex-column justify-content-center">
					...
					<a class="dropdown-item preview-item">
						<div class="preview-thumbnail">
							<img src="resources/admin-assets/images/faces/face3.jpg"
								alt="image" class="profile-pic">
						</div>
						<div
							class="preview-item-content d-flex align-items-start flex-column justify-content-center">
